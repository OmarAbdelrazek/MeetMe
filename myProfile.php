        ...
        <div class="page-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="tab-content px-3 px-xl-5" id="myTabContent">
                    ...
                    <h5 class="text-dark mb-1">Posts:</h5>

                      <?php

                      $query  = 'SELECT posts.* , users.first_name ,users.gender ,users.pic, users.last_name from posts , users where posts.user_id = users.user_id AND users.user_id = '.$_SESSION['userId'].' order by posts.post_time desc';
                      $result = mysqli_query($link, $query);
